...
mycam42 = ONVIFCamera('192.168.15.42', 80, 'admin', 'Supervisor')
mycam43 = ONVIFCamera('192.168.15.43', 80, 'admin', 'Supervisor')

#catching streams
str42=cv2.VideoCapture('rtsp://192.168.15.42:554/2') # slash is for reducing the size of the frame
str43=cv2.VideoCapture('rtsp://192.168.15.43:554/2')  

#creating histogram
#42
fig=plt.figure(figsize=(2, 4)) #creating a figure with 8 pictures
color = ('b','g','r')
...
#creating services for 42 and 43 cameras (other cameras were unavailable)
...
if cb43 >127.5:
    ...
    while cb43 > 127.5:
        ...
        cb43 = cb43 - 1.0  
'''
e43 = request43.Exposure.ExposureTime
e42 = request42.Exposure.ExposureTime
'''
